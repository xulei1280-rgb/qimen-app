...
const strictFollowChildPattern = scriptContext.BaziEngine.analyzePattern({ pillars: { year: '甲子', month: '丙寅', day: '癸酉', hour: '乙卯' }, dayStem: '癸' });
